  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-top-full",
  {
    variants: {
      variant: {
        ...
        warning:
          "warning group border-orange-500 bg-orange-50 text-orange-700 dark:bg-orange-900/30 dark:border-orange-600 dark:text-orange-300",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "group-[.warning]:border-orange-500/40 group-[.warning]:hover:border-orange-500/30 group-[.warning]:hover:bg-orange-100 group-[.warning]:hover:text-orange-800 group-[.warning]:focus:ring-orange-500 dark:group-[.warning]:hover:bg-orange-800/50 dark:group-[.warning]:hover:text-orange-200",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      "group-[.warning]:text-orange-400 group-[.warning]:hover:text-orange-600 group-[.warning]:focus:ring-orange-400 group-[.warning]:focus:ring-offset-orange-50 dark:group-[.warning]:text-orange-500 dark:group-[.warning]:hover:text-orange-300",
      className
    )}
    toast-close=""
    {...props}
