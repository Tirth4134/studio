...
export default function InvoicePreview({
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white">
      ...
      <div className="border-2 border-black">
        ...
        <div className="border-b border-black">
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-black">
                <th className="border-r border-black p-1 w-8">SI</th>
            ...
            <tbody>
              {invoiceItems.length === 0 ? (
                ...
                invoiceItems.map((item, index) => (
                  <tr key={`${item.id}-${index}`} className="border-b border-black">
                    ...
                    <td className="border-r border-black p-1 text-center">{item.category || '84151010'}</td>
                    ...
                    <td className="border-r border-black p-1 text-center">-</td>
                    <td className="border-r border-black p-1 text-right">{item.total.toFixed(2)}</td>
                    <td className="no-print p-1 text-center">
                      <Button
                        variant="outline"
                        size="sm"
              ...
              <tr className="border-b-2 border-black font-bold">
                <td colSpan={3} className="border-r border-black p-1 text-right">Total</td>
                <td className="border-r border-black p-1 text-center">{totalQuantity} PCS</td>
                <td className="border-r border-black p-1">&nbsp;</td>
                <td className="border-r border-black p-1">&nbsp;</td>
                <td className="border-r border-black p-1">&nbsp;</td>
                <td className="border-r border-black p-1 text-right">₹ {subTotal.toFixed(2)}</td>
        ...
        <div className="border-b border-black">
          <table className="w-full text-xs">
            ...
            <tbody>
              <tr className="border-b border-black">
                <td className="border-r border-black p-1">84151010</td>
                <td className="border-r border-black p-1 text-right">{subTotal.toFixed(2)}</td>
                <td className="border-r border-black p-1 text-center">14%</td>
                <td className="border-r border-black p-1 text-right">{(taxAmount / 2).toFixed(2)}</td>
                <td className="border-r border-black p-1 text-center">14%</td>
                <td className="border-r border-black p-1 text-right">{(taxAmount / 2).toFixed(2)}</td>
                <td className="p-1 text-right">{taxAmount.toFixed(2)}</td>
        ...
        {/* Tax amount in words */}
        <div className="border-b border-black p-2 text-xs">
          <div><strong>Tax Amount (in words):</strong> INR Eight Thousand Three Hundred Twelve and Fifty paise Only</div>
        </div>
      ...
      {/* Action Buttons */}
      <div className="no-print p-4 flex justify-between bg-gray-50">
        <Button variant="destructive" onClick={onClearInvoice}>
          <Trash2 className="mr-2 h-4 w-4" /> Clear Invoice
        </Button>
